...
<head>
    ...
    <?php else: ?>
        <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(asset('upload/no_image.jpg')); ?>"
...
<body>
    ...
    <div class="menu-content" style="display: none;  right: 0;">
                                    ...
                                    <?php $__currentLoopData = get_pages_both_footer()->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="nav-item">
                                            <div class="d-flex align-items-center"
                                                style="justify-content: space-between">
                                                <a class="nav-link-item"
                                                    href="<?php echo e(route('page.about', $page->slug)); ?>">
                                        ...
                                        <?php else: ?>
                                            <li class="nav-item">
                                                <div class="d-flex align-items-center"
                                                    style="justify-content: space-between">
                                                    <a class="nav-link-item"
                                                        href="<?php echo e(route('bangla.language')); ?>">বাংলা</a>
                                                </div>
                                            </li>
                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="mobile-header-info-wrap">
            ...
            <div class="single-mobile-header-info">
                <a href="tel:<?php echo e(get_setting('phone')->value ?? ''); ?>"><i
                        class="fi-rs-headphones"></i><?php echo e(get_setting('phone')->value ?? ''); ?> </a>
            </div>
        </div>
    ...
    <?php if(get_setting('messenger_status')->value == 1): ?>
        ...
        <script>
            window.fbAsyncInit = function() {
                FB.init({
                    xfbml: true,
                    version: '<?php echo e(get_setting('messenger_version ')->value ?? ''); ?>'
                });
            };
