                ...
                <div class="container">
                    <div class="row">
                        <div class="section-title">
                            ...
                            <a class="read_more" href="{{ route('product.category', $home2_featured_category->slug) }}">আরো দেখুন</a>
                        </div>
                    </div>
                    <div class="row g-2">
        ...
        @if(count($todays_sale) > 0)
            <div class="row" style="margin-top:30px">
                <div class="section-title">
                    ...
                    <a class="read_more" href="{{ route('product.recently-sell.books') }}">আরো দেখুন</a>
                </div>
            </div>
